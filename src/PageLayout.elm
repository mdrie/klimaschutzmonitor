...
pageLayout : String -> Bool -> View msg -> OldH.Html msg
pageLayout currentPath showMobileMenu pageView =
    div []
        [ globalStyle
        , nav [ A.css [ headerStyle ] ]
            ...
            , ul [ A.css [ menuStyle.menu ], A.class "menu" ]
                [ menuEntry currentPath "/" "Städte"
                , menuEntry currentPath "https://github.com/mdrie/klimaschutzmonitor" "GitHub"
                ]
            ]
...
menuEntry : String -> String -> String -> Html msg
    ...
    let
        ...
        attrList =
            if isActive then
                ...
                []
    in
    li [ A.for "hamburger-check", A.css [ menuStyle.item ] ] [ a [ A.css (menuStyle.button :: attrList), A.href linkPath ] [ text menuText ] ]
