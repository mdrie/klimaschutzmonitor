        ...
        [ div [ css [ C.width (C.pct 100), C.margin (C.px 3) ] ]
            [ div
                ...
                (if List.isEmpty static.data.navCategories then
                    ...
                    a [ href "." ] [ text cityData.name ]
                        :: List.map (\cat -> a [ href cat.data.id ] [ text cat.data.title ]) static.data.navCategories
            ...
            , div
                ...
                (CategoryTree.toList static.data.topCategory.subCategories |> List.map viewCategoryCard)
            , div
                [ css
                    [ C.displayFlex
                    , C.flexWrap C.wrap
...
viewCategoryCard : CategoryTreeData -> Html Msg
viewCategoryCard catTreeEntry =
    div
        [ css
            [ C.width (C.pct 100)
            , M.withMedia [ M.all [ M.minWidth (C.px 1200) ] ] [ C.width (C.pct 25) ]
        ...
        [ div
            ...
            [ div [ css [ C.padding2 (C.px 0) (C.px 20) ] ] [ a [ href catTreeEntry.data.id ] [ text catTreeEntry.data.title ] ]
            , viewSubCategories catTreeEntry.subCategories
            , viewGoals catTreeEntry.goalStates
            ]
        ]


viewSubCategories : CategoryTree -> Html Msg
viewSubCategories tree =
                    ...
                    |> List.map
                        (\catTreeEntry ->
                            div
                                ...
                                [ a [ href catTreeEntry.data.id ] [ text catTreeEntry.data.title ] ]
                        )
                )
